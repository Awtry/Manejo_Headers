...
public class Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String valFor1 = request.getParameter("a");
        String valFor2 = request.getParameter("b");
        String valFor3 = request.getParameter("c");
        String resFor1 = request.getParameter("res1");
        String resFor2 = request.getParameter("res2");
        ...
        switch (opcion) {
            case "1":
                ...
                out.print("<td class='columna'>Valor A:</td><td><tr style='text-align: center'>" + valFor1 + "</td></tr>");
                out.print("<td class='columna'>Valor B:</td><td><tr style='text-align: center'>" + valFor2 + "</td></tr>");
                out.print("<td class='columna'>Valor C:</td><td><<tr style='text-align: center'>" + valFor3 + "</td></tr>");
                //out.print("<tr style='text-align: center'>" + "<td>" + "<button class='default' onClick='calcularGeneral()'> Calcular </button>" + "</td>" + "</tr>");
                out.print("<td class='columna'>Valor C:</td><td><<tr style='text-align: center'>" + resFor1 + "</td></tr>");
                out.print("<td class='columna'>Valor C:</td><td><<tr style='text-align: center'>" + resFor2 + "</td></tr>");
            ...
            default:
                ...
                out.print("<h4>Resultados Finales: </h4>");
                out.print("<form action='/Manejo_Headers/ServletH' method='post' onsubmit='return validarForma(this)'>");
